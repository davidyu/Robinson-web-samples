...
function StartApp() {
    if (app == null) {
        ...
        testScene.addRenderable(new Sphere(1, new gml.Vec4(-1.33333, 0, 0, 1), new CookTorranceMaterial(new gml.Vec4(0.9, 0.9, 0.6, 1), new gml.Vec4(0.9, 0.9, 0.6, 1), 0.8, 1.53)));
