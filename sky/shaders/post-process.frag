...
const float maxblur = 4.0;
const float aperture = 2.2;   // bigger for shallower depth of field

// TODO make me focal length rather than compressed z space
const float focus = 0.994;    // focus distance (in depth buffer (z) space...so it's highly compressed)
